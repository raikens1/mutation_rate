...
new.signal <- c(new.signal, "TCA->T", "ACT->T", "GCC->T", "ACA->T", "GCT->T")
# new.signal now contains all 3mers from table 1, excluding the 4 previsouly reported C->Ts in EUR.signal
