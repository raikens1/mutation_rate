...
```{r S F 8, fig.height=8}
a <- CI.plot(AFR_3mer_counts, EUR_3mer_counts, EAS_3mer_counts, SAS_3mer_counts, mut = "CAC->C", dataset = "1,000 Genomes")
b <- CI.plot(AFR_3mer_counts, EUR_3mer_counts, EAS_3mer_counts, SAS_3mer_counts, mut = "TAT->T", dataset = "1,000 Genomes")
c <- CI.plot(AFR_3mer_counts, EUR_3mer_counts, EAS_3mer_counts, SAS_3mer_counts, mut = "GAC->C", dataset = "1,000 Genomes")
d <- CI.plot(AFR_3mer_counts, EUR_3mer_counts, EAS_3mer_counts, SAS_3mer_counts, mut = "AAC->C", dataset = "1,000 Genomes")
e <- CI.plot(AFR_3mer_counts, EUR_3mer_counts, EAS_3mer_counts, SAS_3mer_counts, mut = "TAC->C", dataset = "1,000 Genomes")

f <- CI.plot(SGDP_AFR_3mer_counts, SGDP_EUR_3mer_counts, SGDP_EAS_3mer_counts, SGDP_SAS_3mer_counts, mut = "CAC->C", dataset = "SGDP")
g <- CI.plot(SGDP_AFR_3mer_counts, SGDP_EUR_3mer_counts, SGDP_EAS_3mer_counts, SGDP_SAS_3mer_counts, mut = "TAT->T", dataset = "SGDP")
h <- CI.plot(SGDP_AFR_3mer_counts, SGDP_EUR_3mer_counts, SGDP_EAS_3mer_counts, SGDP_SAS_3mer_counts, mut = "GAC->C", dataset = "SGDP")
i <- CI.plot(SGDP_AFR_3mer_counts, SGDP_EUR_3mer_counts, SGDP_EAS_3mer_counts, SGDP_SAS_3mer_counts, mut = "AAC->C", dataset = "SGDP")
j <- CI.plot(SGDP_AFR_3mer_counts, SGDP_EUR_3mer_counts, SGDP_EAS_3mer_counts, SGDP_SAS_3mer_counts, mut = "TAC->C", dataset = "SGDP")

grid.arrange(a,b, c, d, e, blank, blank, blank, f, g, h, i, j, blank, blank, blank, ncol = 4)
```

**Supplementary Figure 8:** Approximate 95% confidence intervals of estimated mutation rate for all signature #3 polymorphisms.  Rate estimates are shown for Africa (AFR), Europe (EUR), South Asia (SAS), and East Asia (EAS) within 1,000 Genomes (A-E) and SGDP (F-J).
...
**Supplementary Figure 9:** Approximate 95% confidence intervals of estimated mutation rate for all signature #5 polymorphisms.  Rate estimates are shown for Africa (AFR), Europe (EUR), South Asia (SAS), and East Asia (EAS) within 1,000 Genomes (A-D) and SGDP (E-H).
...
**Supplementary Figure 11:** Rates of all 7-mer expansions of each signature #2 polymorphism in Africa versus East Asia. Again, the population-specific enrichment is consistent across 7mers, consistent with case II.
...
```{r S12 make figure, fig.height = 7.5, fig.width=7}
...
**Supplementary Figure 12:** Rates of all 7-mer expansions of each signature #3 signature in Japanese versus Chinese Dai. Labeled points are those which were significantly variable between Japanese and Chinese Dai (fdr < 0.05 among all signature #3 7-mer expansions).

***********************************************************************************************************

\pagebreak

```{r S F 13, fig.height=3, fig.width=4, fig.align= "center"}
