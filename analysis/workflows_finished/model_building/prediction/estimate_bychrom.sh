...
for i in {1..22}; do
	...
	bsub -q voight_normal -o ${handle}.out -e ${handle}.err "predict_polymorphism.py ../../../../vcf_filtration/nc_bedfiles/nc_chr${i}_regions.bed ../results/AFR_3mer_model_params.txt 0 ${tcounts[`expr ${i} - 1`]}"
done
