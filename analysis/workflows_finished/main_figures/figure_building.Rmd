...
```{r F1A make, fig.height=6.21, fig.width=5.86}
...
s1 <- c("TCT->T", "ACC->T", "TCA->T", "CCC->T", "ACT->T", "TCC->T")
...
s3 <-c("ACG->T", "CCG->T", "GCG->T", "TCG->T")
c <- CI.plot.bygroup(AFR_3mer_counts, EUR_3mer_counts, EAS_3mer_counts, SAS_3mer_counts, s3, "signature 3")
...
```{r F1E make, fig.height=2.5, fig.width = 2.5}
CI.plot.subpop.bygroup(subpops1E, muts1E, popnames1E, colors1E, "signature 4")
```
