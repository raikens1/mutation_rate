...
counts.JPTCHBCHS.7mer <- read.delim("subpops/7mer/JPTCHSCHB_EAS_7mer_counts.txt")
...
```{r X enriched 7mers, echo = F, eval = F}
...
#3mer groups
chi.bycluster(data = counts.JPT.3mer, gw = gw.3mer,dr = dr.3mer.EASonly, k = 2, n = 1, exclude = c()) # p = 0.97, non-JPT-enriched group
chi.bysubset(data = counts.JPT.3mer, gw = gw.3mer, muts = JPT3mers) # p = 0.2, JPT enriched group

#5mer groups
chi.bycluster(data = counts.JPT.5mer, gw = gw.5mer,dr = dr.5.JPT3mers, k = 4, n = 1, exclude = c()) # p = 0.075

#7mer groups
chi.bycluster(data = counts.JPT.7mer, gw = gw.7mer,dr = dr.7.JPT3mers, k = 2, n = 2) # p = 0.009
chi.bycluster(data = counts.JPT.7mer, gw = gw.7mer,dr = dr.7.JPT3mers, k = 2, n = 2, # p = 0.83
              exclude = c("CAAACCC->C", "CCCACAG->C", "TTTATTT->T"))
chi.bycluster(data = counts.JPT.7mer, gw = gw.7mer,dr = dr.7.JPT5mers, k = 7, n = 1) # p = 0.002
...
```{r X enrichment across all contexts, eval = F}
# 3mers 
