...
```{r specialized heatmap, echo = F, eval = F}
...
#5mer groups
chi.bycluster(data = counts.JPT.5mer, gw = gw.5mer,dr = dr.5.JPT3mers, k = 5, n = 1, exclude = c()) # p = 0.076
...
```{r X enrichment across all contexts}
# 3mers 
